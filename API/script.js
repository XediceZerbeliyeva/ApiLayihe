...
const leftValyuta=document.querySelector('.left-show-valyuta');
const rightValyuta=document.querySelector('.right-show-valyuta');
...
leftValyuta.innerText=`1 ${getLeftActiveBtn}=${responseLeft.rates[`${getRightActiveBtn}`]} ${getRightActiveBtn}`;
rightInput.value=Number(leftInput.value)*responseLeft.rates[getRightActiveBtn];
rightValyuta.innerText=`1 ${getRightActiveBtn}=${responseRight.rates[`${getLeftActiveBtn}`]}${getLeftActiveBtn}`;
